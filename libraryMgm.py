...
class main:
    ...
    def cur(self):
        ...
        self.photo9 = PhotoImage(file="assets/afterlogin1.png")
        ...
        self.logo = PhotoImage(file='assets/bt1.png')
        ...
        self.log = PhotoImage(file='assets/bt2.png')
        ...
        self.logb = PhotoImage(file='assets/bt3.png')
        ...
        self.log4 = PhotoImage(file='assets/bt4.png')
        ...
        self.log5 = PhotoImage(file='assets/bt5.png')
        ...
        self.log6 = PhotoImage(file='assets/bt6.png')
        ...
        self.log7 = PhotoImage(file='assets/bt7.png')
            ...
            def submit1(self):
                try:
                    ...
                    if (self.id and self.ttl and self.aut and self.edi and self.pri):
                        ...
                        dbstore.commit()
                        messagebox.showinfo("Success", "Book has been added to the library successfully")
    ...
    def issuebook(self):
        class test(main):
            ...
            def issue(self):
                ...
                #Back Button (clickable image)
                self.backbt = Button(self.fmi, width=60, bg='#ffe8ec', bd=0, relief='flat', activeforeground='black', activebackground='#ffe8ec',
            ...
            def data(self):
                ...
                if (int(self.var[11])>=3):
                    try:
                        ...
                        messagebox.showerror("Unable to process request", "Yoy exceed the limit of Books per student!")
                        self.flag = 1
                        self.cur()
                ...
                if self.value != None:
                    if self.flag != 1:
                        ...
                        self.boot.iconbitmap("assets/aa.ico")
                        ...
                        self.label = Label(self.fr, text='ADD MORE BOOKS', bg='#ffe8ec', fg='black', font=('times new roman', 11, 'bold'))
                        ...
                        self.button1 = Button(self.boot, text='ISSUE', bg='#adefd1', fg='#00203f', width=10, height=0,
                                            font=('Canara', 11, 'bold'), activebackground='#adefd1', command=self.issued)
                        ...
                        btn1 = Button(self.boot, text="CONFIRM DATE", command=self.get_data, bg='#343148',
                                    font=('Canara', 11, 'bold'), fg='#d7c49e', activebackground='black', activeforeground='#d7c49e', relief='flat')
            ...
            def yes(self):
                ...
                self.bt1 = Button(self.fr, text='SUBMIT', width=8, bg='#adefd1', fg='#00203f', font=('Canara', 12, 'bold'), bd=5, relief='flat',
                                    command=self.data, activebackground='#00203f', activeforeground='#adefd1', state=ACTIVE)
                self.bt1.place(x=15, y=160)
            ...
            def no(self):
                self.bt1 = Button(self.fr, text='SUBMIT', width=8, bg='#adefd1', fg='#00203f', font=('Canara', 12, 'bold'), bd=5, relief='flat',
                                    command=self.data, activebackground='#00203f', activeforeground='#adefd1', state=DISABLED)
                self.bt1.place(x=15, y=160)
            ...
            def mail(self):
                ...
                try:
                    ...
                    print("ok")
                    messagebox.showinfo("Library System", "Send main Successfully !")
                except Exception as e:
                    pass
    ...
    def edit(self):
        class editing(main):
            def edbooks(self):
                ...
                #Back Button (clickable image)
                self.backbt = Button(self.ffm, width=60, bg='#ffe8ec', bd=0, relief='flat', command=self.cur, activebackground='#ffe8ec')
            ...
            def searchedit(self):
                ...
                if self.val != None:
                    ...
                    self.edcat.iconbitmap("assets/aa.ico")
                    ...
                    if int(self.data[11]) >= 1:
                        ...
                        if self.var != None:
                            ...
                            if chm <= 0:
                                ...
                                self.tom.iconbitmap("assets/aa.ico")
    ...
    def delete(self):
        class dele(main):
            def deletebooks(self):
                ...
                #Back Button (clickable image)
                self.backbt = Button(self.ff, width=60, bg='#ffe8ec', bd=0, relief='flat', command=self.cur, activeforeground='black', activebackground='#ffe8ec')
                self.backbt.place(x=0, y=0)
                self.log = PhotoImage(file='assets/backbtn1.png')
                self.backbt.config(image=self.log, compound=LEFT)
                self.small_log = self.log.subsample(2, 2)
            ...
            def deldata(self):
                ...
                if self.validation != None:
                    ...
                    dbstore.commit()
                    messagebox.showinfo("Successful", "The book is successfully removed from the store!")
                    self.entry4.delete(0, END)
                else:
    ...
    def login(self):
        ...
        if self.ab != None:
            ...
            self.ig = PhotoImage(file='assets/library.png')
    ...
    def mouseClick(self, event):
        ...
        self.rog.iconbitmap("assets/pass.ico")
    ...
    def code(self):
        ...
        self.photo = ImageTk.PhotoImage(file = r"assets/main_bg.jpg")
        ...
        self.logo = PhotoImage(file=r"assets/login.png")
        ...
        self.log = PhotoImage(file=r"assets/clear.png")
